 ...
 *
 * データについて
 * * skillComb  スキルの組み合わせ。{ スキル系統: ポイント } というオブジェクト
 *   e.g.
 *     { '攻撃': 3, '斬れ味': 1 }
 *
 * * bulk  正規化した結果の、スキルの組み合わせと装備をまとめたもの
 *   e.g.
 *     { skillComb: { '攻撃': 3, '斬れ味': 1 }, equips: [ 'head1', 'head2', ... ] }
 *
...
class Normalizer {
    ...
    _normalize1(equips, skillTrees) {
        let decoCombs = util.deco.skillCombs(this.context.decos, skillTrees);
        let ret = {};
