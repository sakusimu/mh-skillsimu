 ...
 *     c.combine(skillnames, bulksSet, equips);
 *     => [
...
class Combinator {
    ...
    combine(skillnames, bulksSet, equips) {
        ...
        let totalSlot = this._calcTotalSlot(equips);
